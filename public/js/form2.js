    ...
    checkSittingDayTimeIsAsPerGO: function checkSittingDayTimeIsAsPerGO(row, i) {
      if (row.isPartime) {
        ...
        if (this.hasFirst(row.slots)) {
          if (!(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.timePeriodIncludesPeriod)(row.from, row.to, PT_06_05, PT_11_25) && !(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.timePeriodIncludesPeriod)(row.from, row.to, PT_HOSTEL_07_05, PT_HOSTEL_12_25)) {
            //hostel
        ...
        if (this.hasFirst(row.slots)) {
          ...
          if (!(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.timePeriodIncludesPeriod)(row.from, row.to, FT_06_05, FT_16_25) && !(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.timePeriodIncludesPeriod)(row.from, row.to, FT_HOSTEL_07_05, FT_HOSTEL_17_25)) {
        ...
        if (this.hasFirst(row.slots)) {
          if (!(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.timePeriodIncludesPeriod)(row.from, row.to, _utils_js__WEBPACK_IMPORTED_MODULE_0__.REG_08_05, _utils_js__WEBPACK_IMPORTED_MODULE_0__.REG_17_25)) {
