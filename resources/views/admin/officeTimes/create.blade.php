                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.office-times.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('sittingday_duration_min_for_second_ot') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="sittingday_duration_min_for_second_ot" id="sittingday_duration_min_for_second_ot" value="{{ old('sittingday_duration_min_for_second_ot', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('workingday_duration_min_for_first_ot') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="workingday_duration_min_for_first_ot" id="workingday_duration_min_for_first_ot" value="{{ old('workingday_duration_min_for_first_ot', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('sitting_ot_time_str') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="sitting_ot_time_str" id="sitting_ot_time_str" value="{{ old('sitting_ot_time_str', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('sitting_ot_initial_leeway_min') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="sitting_ot_initial_leeway_min" id="sitting_ot_initial_leeway_min" value="{{ old('sitting_ot_initial_leeway_min', '10') }}" step="1">
