    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.govt-calendars.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('success_attendance_fetched') ? 'is-invalid' : '' }}" type="number" name="success_attendance_fetched" id="success_attendance_fetched" value="{{ old('success_attendance_fetched', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('attendance_today_trace_fetched') ? 'is-invalid' : '' }}" type="number" name="attendance_today_trace_fetched" id="attendance_today_trace_fetched" value="{{ old('attendance_today_trace_fetched', '0') }}" step="1">
