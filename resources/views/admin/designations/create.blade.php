...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.designations.store']]) !!}
		...
		<div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                        ...
                        <div class="form-group {{ $errors->has('has_additional_ot') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="has_additional_ot" id="has_additional_ot" value="1" {{ old('has_additional_ot', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('office_time') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="office_time_id" id="office_time_id">
                                @foreach($office_times as $id => $entry)
                                    <option value="{{ $id }}" {{ old('office_time_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
