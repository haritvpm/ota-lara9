        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.shiftTime.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.shift-times.update", [$shiftTime->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('groupname') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="groupname" id="groupname" value="{{ old('groupname', $shiftTime->groupname) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('shift_minutes') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="shift_minutes" id="shift_minutes" value="{{ old('shift_minutes', $shiftTime->shift_minutes) }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('minutes_for_ot') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="minutes_for_ot" id="minutes_for_ot" value="{{ old('minutes_for_ot', $shiftTime->minutes_for_ot) }}" step="1">
