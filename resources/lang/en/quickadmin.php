...
return [
	...
	'designations' => [
		...
		'fields' => [
			...
			'rate' => 'Rate',
			'designation-mal' => 'Designation mal',
		],
	],
	...
	'routing' => [
		...
		'fields' => [
			'user' => 'User',
			'route' => 'Route',
			'last-forwarded-to' => 'Last Forwarded To',
		],
	],
	...
	'employees-other' => [
		'title' => 'Employees Other Dept',
		'fields' => [
			'srismt' => 'Sri/Smt',
			'name' => 'Name',
			'pen' => 'PEN',
			'designation' => 'Designation',
			'department-idno' => 'Dept No. (if any)',
			'added-by' => 'Added by',
			'account-type' => 'Bank/ Treasury',
			'ifsc' => 'IFSC (if TSB, leave empty)',
