...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('categories')->where('category','PartTime Employees')->update(array(
                    'normal_office_hours'=> 3));
        
        DB::table('categories')->where('category','FullTime Employees')->update(array(
                        'normal_office_hours'=> 6));
        DB::table('categories')->where('category','Watch and Ward')->update(array(
                            'punching' => 0));
